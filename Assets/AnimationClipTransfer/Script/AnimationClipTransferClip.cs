...
public class AnimationClipTransferClip : PlayableAsset, ITimelineClipAsset
{
    ...
    public override Playable CreatePlayable (PlayableGraph graph, GameObject owner)
    {
        ...
        // var initialAnimationClip = new AnimationClip();
        // Keyframe[] keys;
        // keys = new Keyframe[3];
        // keys[0] = new Keyframe(0.0f, 0.0f);
        // keys[1] = new Keyframe(1.0f, 3.0f);
        // keys[2] = new Keyframe(2.0f, 1.0f);
        // var curve = new AnimationCurve(keys);
        // initialAnimationClip.SetCurve("", typeof(AnimationClipTransferBehaviour), "template.a", curve);
        // playable.SetAnimatedProperties(initialAnimationClip);

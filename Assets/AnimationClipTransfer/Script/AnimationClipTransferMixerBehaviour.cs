...
public class AnimationClipTransferMixerBehaviour : PlayableBehaviour
{
    ...
    public override void ProcessFrame(Playable playable, FrameData info, object playerData)
    {
        ...
        { 
            ...
            {
                var ratio = clipAsset.StaggerOption.StaggerRatio;
                if (clipAsset.StaggerOption.In && clipAsset.StaggerOption.Out) ratio *= 0.5f;
                ...
                {
                    var isIn = clipAsset.StaggerOption.In;
                    var isOut = clipAsset.StaggerOption.Out;
    ...
    private void UpdateAnimation(TimelineClip clip, GameObject target, TransformCash transformCash,Animation animation, float progress )
    {
        ...
        // }
        // if (clip.start > Director.time && transformCash.Progress != 0) 
        // {
        //     
        //     Debug.Log($"Before");
        //     animation.clip.SampleAnimation(target,0*animation.clip.averageDuration); 
        //     if(clipAsset.ToggleActiveOnClip) target.SetActive(false);
        //     transformCash.Progress = progress;
        // }
        //
        //
        // if (clip.end< Director.time && transformCash.Progress != 1) 
        // {
        //     
        //     Debug.Log($"After");
        //     animation.clip.SampleAnimation(target,1 *animation.clip.averageDuration); 
        //     if(clipAsset.ToggleActiveOnClip) target.SetActive(false);
        //     transformCash.Progress = progress;
        // }
    }
